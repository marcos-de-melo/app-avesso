...
<body>
    ...
    <div class="container column align-items-center justify-content-center">
        ...
        <div class="row">
            <div class="card col-12 col-sm-3 d-flex align-items-center pt-4">
                ...
                <div class="round-image" id="divFotoPerfil"
                    style="background-image: url(img/photos-profile-users/<?= $nomeFoto ?>)"></div>
            ...
            <div class="col-12 col-sm-9 column align-items-center justify-content-center">
                <h2>Adicione ao menos duas <span class="text-primary">fotos</span> e duas <span
                        class="text-primary">perguntas</span></h2>
                <!-- <div class="galeria-fotos mb-4">

                    <?php
                    // $sql = "select * from tbfotos_usuarios where idUsuario = '{$_SESSION["idUsuarioLogado"]}'";
                    // $rs = mysqli_query($conn, $sql);
                    // while ($dados = mysqli_fetch_assoc($rs)) {
                    //     $nomeArquivoFoto = $dados["nomeArquivoFoto"];
                    //     ?>
                    //     <div class="square-image" id="divFotoPerfil"
                    //         style="background-image: url(img/galery-photo-users/<?= $nomeArquivoFoto ?>)"></div>
                    //     <?php
                    // }
                    ?>
    ...
    <footer class="fixed-bottom">
        <div class="border-light border-top border-3 p-4 container d-flex align-items-between justify-content-between">
            ...
            <a id="btn-proximo" class="text-primary" href="index.php">
                <?= $PularProximo ?> <i class="bi bi-arrow-right"></i>
            </a>
        </div>
    </footer>
    <script src="./js/jquery.js"></script>
    <script src="./js/upload-lote.js"></script>
